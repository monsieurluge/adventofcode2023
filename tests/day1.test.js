...
import { calibration, firstDigit, lastDigit } from '../puzzles/day1.js'
...
test('calibration function should join the first and last digits encountered in a string', (expect) => {
    // arrange
    const string1 = '1abc2'
    const string2 = 'pqr3stu8vwx'
    const string3 = 'a1b2c3d4e5f'
    const string4 = 'treb7uchet'
    // act
    const result1 = calibration(string1)
    const result2 = calibration(string2)
    const result3 = calibration(string3)
    const result4 = calibration(string4)
    // assert
